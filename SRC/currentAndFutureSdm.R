...
# mask the raster object that determines the area we're interested in  
...
#standardize randome points for reproducability
...
#create a grid for climate measurement, per occurrence point
occEnv <- na.omit(raster::extract(x = currentClimRasterStack, y = occurrenceCoords))

#create a grid measurement s for the psuedo absence points
